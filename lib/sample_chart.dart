...
class SampleChart extends StatefulWidget {
  SampleChart({Key key, this.title}) : super(key: key);

  static const String routeName = "/SampleChart";

  final String title;

  @override
  _SampleChartState createState() => new _SampleChartState();
}

/// // 1. After the page has been created, register it with the app routes
/// routes: <String, WidgetBuilder>{
///   WeatherDetail.routeName: (BuildContext context) => new WeatherDetail(title: "WeatherDetail"),
/// },
///
...
//       ">+2%"
     ...
     _lineChartOptions.lineStrokeWidth = 3.5;
//     _lineChartOptions.hotspotOuterRadius = 0.0;
//     _lineChartOptions.hotspotInnerRadius = 0.0;
